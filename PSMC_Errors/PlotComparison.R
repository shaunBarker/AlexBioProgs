...
#plot(log(TrueTimes),TruePops,"s",ylim=c(0,15),xlim=c(-4,4),lwd=4)
...
# START HERE 
plot(log(TrueTimes),TruePops,"s",ylim=c(0,15),xlim=c(-4,4),lwd=5,main="30Mbp")
...
plot(log(TrueTimes),TruePops,"s",ylim=c(0,40),xlim=c(-3,5),lwd=5,main="20Mbp")
